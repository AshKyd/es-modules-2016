...
(function(process) {
  ...
  exports.default = function() {
    ...
    if (opts.only != null)
      only = _babelCore.util.arrayify(opts.only, _babelCore.util.regexify);
    if (opts.ignore != null)
      ignore = _babelCore.util.arrayify(opts.ignore, _babelCore.util.regexify);
    if (opts.extensions)
      hookExtensions(_babelCore.util.arrayify(opts.extensions));
    if (opts.cache === false)
      cache = null;
  ...
  function compile(filename) {
    var result = void 0;
    var opts = new _babelCore.OptionManager().init((0, _extend2.default)((0, _cloneDeep2.default)(transformOpts), {filename: filename}));
